#!/bin/bash
#SBATCH --job-name=micro-cond-clip-embed-512
#SBATCH --nodes=2
...
OUTPUT_DIR=/fsx/suraj/micro-cond-clip-embed-512
LOG_PATH=$OUTPUT_DIR/main_log.txt
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr39/config.yaml
