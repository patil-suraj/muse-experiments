#!/bin/bash
#SBATCH --job-name=laiona6plus-f8-pixshuffle-512
#SBATCH --nodes=2
...
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr31/config.yaml
OUTPUT_DIR=/fsx/suraj/laiona6plus-f8-pixshuffle
