#!/bin/bash
#SBATCH --job-name=laiona6plus-f8-vanilla-resblocks-ema
#SBATCH --nodes=2
...
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr15/config.yaml
OUTPUT_DIR=/fsx/suraj/laiona6plus-f8-vanilla-resblocks-ema
