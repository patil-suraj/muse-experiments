#!/bin/bash
#SBATCH --job-name=quant-embed-laiona6-f16
#SBATCH --nodes=1
...
OUTPUT_DIR=/fsx/suraj/quant-embed-laiona6-f16
LOG_PATH=$OUTPUT_DIR/main_log.txt
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr34/config.yaml
