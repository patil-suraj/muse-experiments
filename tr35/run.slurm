#!/bin/bash
#SBATCH --job-name=coyo-f8-filtered-resumed-laiona5-384
#SBATCH --nodes=4
...
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr35/config.yaml
OUTPUT_DIR=/fsx/suraj/coyo-f8-filtered-resumed-laiona5-384
