#!/bin/bash
#SBATCH --job-name=laiona6plus-f8-block-attn
#SBATCH --nodes=1
...
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr23/config.yaml
OUTPUT_DIR=/fsx/suraj/laiona6plus-f8-block-attn
