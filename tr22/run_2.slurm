#!/bin/bash
#SBATCH --job-name=test-datacomp-clip-f16-coco-val
#SBATCH --nodes=1
...
OUTPUT_DIR=/fsx/suraj/test-datacomp-clip-f16-coco-val
LOG_PATH=$OUTPUT_DIR/main_log.txt
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr22/config_2.yaml
