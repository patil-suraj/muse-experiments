#!/bin/bash
#SBATCH --job-name=oai-clip-lbl-smooth-laiona5-resumed
#SBATCH --nodes=2
...
OUTPUT_DIR=/fsx/suraj/oai-clip-lbl-smooth-laiona5-resumed
LOG_PATH=$OUTPUT_DIR/main_log.txt
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr36/config.yaml
