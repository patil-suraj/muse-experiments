#!/bin/bash
#SBATCH --job-name=oai-clip-less-res-blocks
#SBATCH --nodes=1
...
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr11/config.yaml
OUTPUT_DIR=/fsx/suraj/oai-clip-less-res-blocks
