#!/bin/bash
#SBATCH --job-name=controlnet-sd-xl-1.0-depth-zoe
#SBATCH --nodes=2
...
OUTPUT_DIR=//fsx/suraj/controlnet-sd-xl-1.0-depth-zoe
...
# --transformer_layers_per_block='0,0,1' --old_style_controlnet \

PROGRAM="train_controlnet_webdataset.py \
