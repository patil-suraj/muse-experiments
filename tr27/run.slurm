#!/bin/bash
#SBATCH --job-name=laiona6plus-f8-tensor1st
#SBATCH --nodes=1
...
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr27/config.yaml
OUTPUT_DIR=/fsx/suraj/laiona6plus-f8-tensor1st
