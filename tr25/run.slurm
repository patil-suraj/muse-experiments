#!/bin/bash
#SBATCH --job-name=oai-clip-lbl-smooth-laiona6-block-attn
#SBATCH --nodes=1
...
OUTPUT_DIR=/fsx/suraj/oai-clip-lbl-smooth-laiona6-block-attn
LOG_PATH=$OUTPUT_DIR/main_log.txt
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr25/config.yaml
