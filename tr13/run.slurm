#!/bin/bash
#SBATCH --job-name=laiona6plus-f8-vanilla-resblocks
#SBATCH --nodes=2
...
CONFIG_PATH=/admin/home/suraj/code/muse-experiments/tr13/config.yaml
OUTPUT_DIR=/fsx/suraj/laiona6plus-f8-vanilla-resblocks
